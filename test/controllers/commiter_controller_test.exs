defmodule GithublicencerWeb.CommiterControllerTest do
  ...
  # commiter_path is now github_repo_commiter_path but takes two
  # params as it is nested under github_repo resource
  # 
